...
function startGame() {
    ...
    myGamePiece = new component(img, 100, 10,  myGameArea.canvas.width / 2 - 50, myGameArea.canvas.height - 20);
    var img = document.getElementById("pokeball");
    myball = new component(img, 30, 40,  myGameArea.canvas.width / 2 - 2.5 - 100, 110);   
    img = document.getElementById("vlakas");
	imageArray = [document.getElementById("vlakas"), document.getElementById("vlakas")]; 
    for (i = 0; i < 30; i++) {
        ...
        myObstacles.push(new component(rand, 40, 50, x, y));
        x = x + 30;
    }
    myGameArea.setsize();
    myball.speedY -= 2;
